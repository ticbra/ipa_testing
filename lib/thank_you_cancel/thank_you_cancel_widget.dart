...
import 'thank_you_cancel_model.dart';
export 'thank_you_cancel_model.dart';

class ThankYouCancelWidget extends StatefulWidget {
  const ThankYouCancelWidget({super.key});

  @override
  State<ThankYouCancelWidget> createState() => _ThankYouCancelWidgetState();
}

class _ThankYouCancelWidgetState extends State<ThankYouCancelWidget> {
  late ThankYouCancelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ThankYouCancelModel());
