...
Future<void> customAlertDialogRegistration(
    ...
    builder: (alertDialogContext) {
      ...
      return AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () {
              Navigator.of(alertDialogContext).pop(); // Closes the dialog.
            },
            child: Text(
  ...
  // Navigate to the login page after the dialog is dismissed
