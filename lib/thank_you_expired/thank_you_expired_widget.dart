...
import 'thank_you_expired_model.dart';
export 'thank_you_expired_model.dart';

class ThankYouExpiredWidget extends StatefulWidget {
  const ThankYouExpiredWidget({super.key});

  @override
  State<ThankYouExpiredWidget> createState() => _ThankYouExpiredWidgetState();
}

class _ThankYouExpiredWidgetState extends State<ThankYouExpiredWidget> {
  late ThankYouExpiredModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ThankYouExpiredModel());
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    16.0, 20.0, 16.0, 0.0),
                                child: Text(
                                  'Vrijeme potrebno za potvrdu rezervacije je isteklo.',
                                  style: FlutterFlowTheme.of(context)
                                      .displayLarge
                                      .override(
                                        fontFamily: 'PT Sans',
