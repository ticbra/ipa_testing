...
import 'list_urgent_page_model.dart';
export 'list_urgent_page_model.dart';

class ListUrgentPageWidget extends StatefulWidget {
  const ListUrgentPageWidget({super.key});

  @override
  State<ListUrgentPageWidget> createState() => _ListUrgentPageWidgetState();
}

class _ListUrgentPageWidgetState extends State<ListUrgentPageWidget> {
  late ListUrgentPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListUrgentPageModel());
